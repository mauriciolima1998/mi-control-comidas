  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-md p-10 flex flex-col items-center gap-6 w-full max-w-sm">
        <h1 className="text-2xl font-bold text-gray-800">Mi Control de Comidas</h1>
        <p className="text-gray-500 text-sm text-center">
          Registrá tus comidas y seguí tus macros diarios con ayuda de IA.
        </p>
        <button
          onClick={signInWithGoogle}
          className="flex items-center gap-3 bg-white border border-gray-300 rounded-lg px-5 py-3 text-gray-700 font-medium shadow-sm hover:shadow-md transition w-full justify-center"
        >
